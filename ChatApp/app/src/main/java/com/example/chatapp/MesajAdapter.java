...
public class MesajAdapter extends RecyclerView.Adapter<MesajAdapter.ViewHolder>{
    ...
    String userName;
    Boolean state;
    int view_send = 1, view_recieved = 2;
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        {
            view = LayoutInflater.from(context).inflate(R.layout.recieve_layout,parent,false);
            return new ViewHolder(view);
        }
    ...
    public class ViewHolder extends RecyclerView.ViewHolder
  {
      ...
      public ViewHolder(View itemView) {
          ...
          {
              textView = itemView.findViewById(R.id.recieved_textview);
          }
